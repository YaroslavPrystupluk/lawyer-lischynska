...
const Header: FC = () => {
	return (
		...
		<header className="bg-[url('/image/back-header.png')] bg-cover bg-no-repeat h-[500px] sm:h-[900px] md:h-[100vh]">
			<Navbar/>
			...
			<section className="text-primary uppercase text-xl sm:text-5xl lg:text-6xl font-bold">
				<div className="container px-8 py-8 mx-auto">
					...
					{/*	</svg>*/}
					<blockquote className='text-center w-full sm:w-1/2 md:w-1/3'>
						<div className='text-xl sm:text-5xl lg:text-6xl font-bold leading-none text-left'>&ldquo;</div>
						<div className='inline-block text-left'>
							<cite className='block'>Репутація,</cite>
							<cite className='block'>повага,</cite>
							<cite className='block'>результат</cite>
						</div>
						<div className='text-xl sm:text-5xl lg:text-6xl font-bold leading-none text-right'>&rdquo;</div>
					</blockquote>
						{/*<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"*/}
