	...
	return (
		<header className="bg-gradient-to-r from-secondary/60 to-secondary">
			...
			<div className="grid grid-flow-row sm:grid-flow-col">
				...
				<div className="flex flex-col md:flex-row items-center sm:px-12 justify-center">
					<section className="text-primary uppercase text-xl sm:text-2xl md:text-4xl xl:text-6xl font-bold">
					...
					<div
						...
						<img className="max-w-full object-cover" src={lawyer} alt="lawyer photo"/>
					</div>
				</div>
			</div>
