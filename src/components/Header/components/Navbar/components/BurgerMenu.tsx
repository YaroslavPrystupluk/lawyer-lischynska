    ...
    return (
        <>
            ...
            >
                ...
                <DialogPanel
                    className="absolute inset-y-0 right-0 z-10 w-full overflow-y-auto  bg-slate-600 px-2 py-2 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                    <div
                        className="mt-2 mx-3 flow-root">
                        <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    className="space-y-2 p-6 flex flex-col gap-4">
