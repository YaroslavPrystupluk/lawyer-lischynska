...
import { ADMIN_ROUTES, COMMON_ROUTES } from "../../../routes/routes.name";

const commonRoutes = Object.entries(COMMON_ROUTES).map(([name, to]) => ({
  name,
  to,
  current: false, // Можеш змінювати це відповідно до логіки
}));
    ...
    >
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch xs:justify-start">
