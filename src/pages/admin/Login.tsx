        ...
        <div className="w-full max-w-sm p-4 bg-white border border-primary rounded-lg shadow-sm sm:p-6 md:p-8">
            <form className="space-y-6" onSubmit={handleLogin}>
                <div className="relative my-4">
                    <TitleChapter
                        className="text-2xl text-center font-bold before:content-[''] before:bg-primary before:absolute before:bottom-[-30%] sm:before:bottom-[-50%] before:left-[50%] before:translate-x-[-50%] before:w-20 before:h-1">
                        Вхід
                    </TitleChapter>
                </div>
                <div>
